        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-white/70">
              Two providers are supported. <Sparkles className="inline h-3.5 w-3.5 align-text-bottom text-accent-purple" /> <b className="text-white">OpenAI</b> hits the OpenAI cloud and uses the <code className="rounded bg-white/10 px-1 text-[11px]">OPENAI_*</code> env vars. <b className="text-white">Custom</b> hits any OpenAI-compatible endpoint (vLLM, Anyscale, Together, your own self-hosted build) configured through the <code className="rounded bg-white/10 px-1 text-[11px]">CUSTOM_AI_*</code> env vars.
            </p>
